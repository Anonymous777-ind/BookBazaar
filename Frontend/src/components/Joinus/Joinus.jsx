...
function Joinus() {
    return (
        <section className='container mx-auto my-16  ' >
           <div className="rounded-md container  mx-auto w-full sm:max-w-3xl lg:max-w-5xl flex flex-col sm:flex-row justify-center lg:justify-between gap-10 shadow-shadow h-auto xs:px-2 xs:py-3">
                ...
                <div className="subscribe-content">
                    ...
                    <form action="">
                        <div className="input my-5 xs:flex-col gap-3">
                            <input className=' text-custom-gray font-custom-sub-heading-para leading-normal' type="mail" placeholder='Your email' required />
                            <button className='btn text-white font-custom-sub-heading-para text-lg px-10 bg-custom-green  xs:rounded-full xs:inline-block xs:text-lg xs:text-center xs:mx-auto ' type="submit">Subscribe</button>
                        </div>
